    ...
    return (
        ...
        <div className="row accRowOne__wrapper">
          ...
          <div className="nav flex-column nav-p">
              ...
              <NavLink to="/vouchers" className="nav-link d-flex justify-content-between">
                <span>{IconStore.ulTicket}
                <span className="adjacentIcon__text">Voucher Credit</span></span>
                <span className="d-inline-block d-md-none pr-2 rightIconMobile">
                  <FaIcon.FaChevronRight />
                </span>
              </NavLink>

              <NavLink to="/saved" className="nav-link d-flex justify-content-between">
                <span>{IconStore.heart}
                <span className="adjacentIcon__text">Saved Items</span></span>
                <span className="d-inline-block d-md-none pr-2 rightIconMobile">
                  <FaIcon.FaChevronRight />
                </span>
              </NavLink>

              <a href="/recentlyViewed" className="nav-link  d-flex justify-content-between">
                <span>{IconStore.baselineHistory}
                <span className="adjacentIcon__text">Recently Viewed</span></span>
                <span className="d-inline-block d-md-none pr-2 rightIconMobile">
                  <FaIcon.FaChevronRight />
                </span>
              </a>
              ...
              <NavLink to="/details" className="nav-link d-flex justify-content-between">
                <span>Details</span>
                <span className="d-inline-block d-md-none pr-2 rightIconMobile">
                  <FaIcon.FaChevronRight />
                </span>
              ...
              <NavLink to="/addressBook" className="nav-link  d-flex justify-content-between">
              ...
              <NavLink to="/changePassword" className="nav-link d-flex justify-content-between">
              ...
              <NavLink to="/newsletter" className="nav-link d-flex justify-content-between">
