    ...
    return (
        <div className="row accRowOne__wrapper">
          ...
          <div className="nav flex-column nav-p">
              ...
              <Link to="/vouchers" className="nav-link d-flex justify-content-between">
              ...
              <Link to="/details" className="nav-link d-flex justify-content-between">
                <span>Details</span>
                <span className="d-inline-block d-md-none pr-2 rightIconMobile">
                  <FaIcon.FaChevronRight />
                </span>
              ...
              <Link to="/addressBook" className="nav-link  d-flex justify-content-between">
              ...
              <Link to="/changePassword" className="nav-link d-flex justify-content-between">
              ...
              <Link to="/newsletter" className="nav-link d-flex justify-content-between">
