    ...
    <div className="productDetailRowThree">
      <Row className="Descriptions">
        <Col className="navGrp">
          <NavLink to="/"><span  className="text-nowrap">PRODUCT DETAILS</span></NavLink>
          <NavLink to="/productReview"><span>REVIEWS</span> </NavLink>
          <NavLink to="/productSpecification"> <span className="text-nowrap"> PRODUCT SPECIFICATION</span></NavLink>
        </Col>
      </Row>
      ...
      <Row>
        <Col lg="9">
          <div className="productDescription tab-content" id="myTabContent">
            ...
            <Route path="/productSpecification" component={SpecificationSection}/>
          </div>
        </Col>
