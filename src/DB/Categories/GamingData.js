export const PriceSlashData_Gaming = [
    {
  ...
  export const PriceSlashData_GamingI = [
    {
  ...
  export const PriceSlashData_GamingII = [
    {
  ...
  export const PriceSlashData_GamingIII = [
    {
  ...
  export const PriceSlashData_GamingIV = [
    {
  ...
  export const PriceSlashData_GamingV = [
    {
  ...
  export const OfficialStoreData_Gaming = [
    {
  ...
  export const OfficialStoreData_GamingI = [
    {
  ...
  export const OrderTableData_Gaming = [
    {
  ...
  export const OrderTableData_GamingI = [
    {
      img: "https://ng.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/10/237746/1.jpg?7233",
      info: "KleanWater Laundry Starch",
    },
  ...
  export const OrderTableData_GamingII = [
    {
  ...
  export const bannerImage_Gaming = [
    {
      bannerImage1: "https://ng.jumia.is/cms/0-categories-tng/gaming/CB-fifav5.jpg",
      bannerImage2: "https://ng.jumia.is/cms/0-1-weekly-cps/2020/w33/xbox/cb-xbox.jpg",
    },
  ];
  


export const PRODUCTORDERS_Gaming = [
    {
    id: '1',
    status: 'Draft',
