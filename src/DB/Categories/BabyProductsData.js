export const PriceSlashData_BabyProducts = [
    {
  ...
  export const PriceSlashData_BabyProductsI = [
    {
  ...
  export const PriceSlashData_BabyProductsII = [
    {
  ...
  export const PriceSlashData_BabyProductsIII = [
    {
  ...
  export const PriceSlashData_BabyProductsIV = [
    {
  ...
  export const PriceSlashData_BabyProductsV = [
    {
  ...
  export const OfficialStoreData_BabyProducts = [
    {
  ...
  export const OfficialStoreData_BabyProductsI = [
    {
  ...
  export const OrderTableData_BabyProducts = [
    {
  ...
  export const OrderTableData_BabyProductsI = [
    {
      img: "https://ng.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/10/237746/1.jpg?7233",
      info: "KleanWater Laundry Starch",
    },
  ...
  export const OrderTableData_BabyProductsII = [
    {
  ...
  export const bannerImage_BabyProducts = [
    {
      bannerImage1: "https://ng.jumia.is/cms/0-categories-tng/baby-products/L1/cb-baby-products.jpg",
      bannerImage2: "https://ng.jumia.is/cms/0-1-weekly-cps/2020/w32/kids-fashion/cb-kids-fashion.jpg",
    },
  ];
  


export const PRODUCTORDERS_BabyProducts = [
    {
    id: '1',
    status: 'Draft',
