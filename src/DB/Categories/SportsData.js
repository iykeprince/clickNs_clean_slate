export const PriceSlashData_Sports = [
    {
  ...
  export const PriceSlashData_SportsI = [
    {
  ...
  export const PriceSlashData_SportsII = [
    {
  ...
  export const PriceSlashData_SportsIII = [
    {
  ...
  export const PriceSlashData_SportsIV = [
    {
  ...
  export const PriceSlashData_SportsV = [
    {
  ...
  export const OfficialStoreData_Sports = [
    {
  ...
  export const OfficialStoreData_SportsI = [
    {
  ...
  export const OrderTableData_Sports = [
    {
  ...
  export const OrderTableData_SportsI = [
    {
      img: "https://ng.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/10/237746/1.jpg?7233",
      info: "KleanWater Laundry Starch",
    },
  ...
  export const OrderTableData_SportsII = [
    {
  ...
  export const bannerImage_Sports = [
    {
      bannerImage1: "https://ng.jumia.is/cms/0-categories-tng/sporting-goods/L1/cb-sporting-goods.jpg",
      bannerImage2: "https://ng.jumia.is/cms/0-categories-tng/sporting-goods/L1/fl-on-the-lawn.jpg",
    },
  ];
  


export const PRODUCTORDERS_Sports = [
    {
    id: '1',
    status: 'Draft',
