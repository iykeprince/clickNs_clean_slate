...
import {CATBANNERIMAGE_HEALTHBEAUTYI, CATBANNERIMAGE_HEALTHBEAUTYII } from "../../components/Category/CatBannerImage";
...
export default function HealthnBeauty() {
    const category = { catName: 'Health and Beauty'}
  ...
  return (
    <React.Fragment>
      ...
      <CategoryProvider value={category}>  
        ...
        <CATBANNERIMAGE_HEALTHBEAUTYI/>

        <ORDERTABLE_SUPERMARKET headingTitle={`Health & Beauty `} />

        <PRICESLASH_SUPERMARKET headingTitle="Budget" />

        <PRICESLASH_SUPERMARKETI headingTitle={`Health & Beauty `} />
        ...
        <PRICESLASH_SUPERMARKETIII headingTitle={`Health & Beauty `}  />

        <PRICESLASH_SUPERMARKETIV headingTitle="Budget" />

        <ORDERTABLE_SUPERMARKETII headingTitle={`Health & Beauty `} />

        <br />
        <br />
        <br />
        <CATBANNERIMAGE_HEALTHBEAUTYII/>

        <OFFICIALSTORE_SUPERMARKET headingTitle="Official Stores" />

        <OFFICIALSTORE_SUPERMARKETI headingTitle={`Health & Beauty `}  />
