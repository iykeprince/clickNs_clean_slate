...
import {CATBANNERIMAGE_OTHERSI, CATBANNERIMAGE_OTHERSII} from "../../components/Category/CatBannerImage";
...
export default function OtherCategories() {
    const category = { catName: 'Other Categories'}
